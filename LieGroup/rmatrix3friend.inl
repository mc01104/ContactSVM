...
template <class TYPE>
bool GenSolveAxEqualB(const _rmatrix<TYPE> &A, _rmatrix<TYPE> &x, const _rmatrix<TYPE> &B)
{
	//bool axbiter(long n,__**A,__*x,__*c) 
...
template <class TYPE>
bool FixedPointSolveLCP_UserIterNum(const _rmatrix<TYPE> &A, _rmatrix<TYPE> &f, const _rmatrix<TYPE> &b, int Iter)
{
	int n, i;
	int iteration = Iter;
