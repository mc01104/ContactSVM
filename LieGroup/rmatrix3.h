...
#define SVD_EPS		1.0E-9 // bk~
//#define _EPS		2.2204E-16 // eigenvalue 구하는 것 때문에 잠시 추가
...
//#include <rmatrix3friend.inl>
#include "../LieGroup/rmatrix3friend.inl"
...
public:
	...
	*/
	...
	/* made by k.h
	*/
	void PushCol(const _rmatrix<TYPE>& );

	void PushRow(const _rmatrix<TYPE>& );
	...
	*/
	TYPE Normalize(void)
	{
		TYPE norm = FNorm(*this), inorm = SCALAR_ONE / norm;
		*this *= inorm;
		return norm;
	}
	//@}
	...
	*/
	...
	friend bool GenSolveAxEqualB<TYPE>(const _rmatrix<TYPE> &A, _rmatrix<TYPE> &x, const _rmatrix<TYPE> &b);
	...
	*/
	...
	/*!
		solve linear complementarity problem.
	...
	*/
	...
	friend bool FixedPointSolveLCP_UserIterNum<TYPE>(const _rmatrix<TYPE> &A, _rmatrix<TYPE> &f, const _rmatrix<TYPE> &b, int Iter);
